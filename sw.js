/* APP-BCB · PWA service worker v4.6 final sync · miembros fire-and-verify estable */
const CACHE_NAME = "app-bcb-pwa-v4-6-0-miembros-fireverify-estable";
const APP_SHELL = [
  "./",
  "./index.html?v=4.6.0-bcb",
  "./manifest.json?v=4.6.0-bcb",
  "./css/styles.css?v=4.6.0-bcb",
  "./css/admin-guard.css?v=4.6.0-bcb",
  "./js/assets.js?v=4.6.0-bcb",
  "./js/data.js?v=4.6.0-bcb",
  "./js/app.js?v=4.6.0-bcb",
  "./js/admin-guard.js?v=4.6.0-bcb",
  ...
  if (isCore) {
    event.respondWith(
      fetch(request, { cache: "no-store" })
        ...
        .catch(() => caches.match(request).then(cached => cached || caches.match("./index.html?v=4.6.0-bcb") || caches.match("./")))
    );
    return;
  }
